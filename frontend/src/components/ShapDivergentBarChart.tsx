...
export const ShapDivergentBarChart: React.FC<ShapDivergentBarChartProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200/90 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl p-6 shadow-xl flex flex-col justify-between h-full">
      {/* Chart Header */}
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-zinc-100 dark:border-zinc-800/80 gap-3">
          <div>
        ...
        {/* Scale Axis Header */}
        <div className="grid grid-cols-12 gap-2 text-[10px] font-sans text-zinc-400 pt-3 pb-2 border-b border-zinc-100 dark:border-zinc-800/60 items-center">
        ...
        <div className="divide-y divide-zinc-100 dark:divide-zinc-800/50 mt-1">
          {sortedFactors.map((item) => {
            ...
            return (
              <div
                key={item.feature}
                className="py-3 px-2 group hover:bg-zinc-50/80 dark:hover:bg-zinc-800/40 rounded-lg transition-all"
              >
                <div className="grid grid-cols-12 gap-2 items-center">
                  ...
                  <div className="col-span-12 sm:col-span-5 pr-2">
                    ...
                    <div className="text-[11px] font-sans text-zinc-500 dark:text-zinc-400 mt-0.5 flex items-center gap-1.5 flex-wrap">
                  ...
                  <div className="col-span-8 sm:col-span-5 flex h-7 items-center relative">
                    {/* Center Line 0.0 */}
                    ...
                    <div className="w-1/2 h-full flex justify-end items-center pr-[1px]">
                      {!isPositive && (
                        <div
                          ...
                          className="h-4.5 bg-gradient-to-l from-emerald-500 to-teal-400 rounded-l-md transition-all duration-700 ease-out shadow-xs group-hover:brightness-110"
                    ...
                    <div className="w-1/2 h-full flex justify-start items-center pl-[1px]">
                      {isPositive && (
                        <div
                          style={{ width: `${Math.min(100, barWidthPercent)}%` }}
                          className="h-4.5 bg-gradient-to-r from-rose-500 to-red-400 rounded-r-md transition-all duration-700 ease-out shadow-xs group-hover:brightness-110"
                ...
                {item.regulatory_reason && (
                  <div className="mt-2 text-[11px] text-zinc-600 dark:text-zinc-300 font-sans leading-relaxed bg-zinc-50/80 dark:bg-zinc-950/40 p-2.5 rounded-md border border-zinc-200/60 dark:border-zinc-800/60">
      ...
      <div className="mt-4 pt-3 border-t border-zinc-100 dark:border-zinc-800/80 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-[10px] font-sans text-zinc-400">
